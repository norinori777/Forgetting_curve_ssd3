...
4. **Generate tasks.md**: Use `.specify/templates/tasks-template.md` as structure, fill with:
  ...
  - Each phase includes: story goal, independent test criteria, tests (constitution-aligned), implementation tasks
...
**Tests are REQUIRED (constitution)**: Include test tasks by default.
Only omit tests when the plan explicitly documents an exception (with rationale) in the Constitution Check section.
