...
### UI Skill Routing (MANDATORY)

- For UI/frontend scope, always load: `.github/agents/frontend.dev.agent.md`
- For UI/frontend scope, always reference design tokens: `./design/design-tokens.md`
- UI/frontend scope indicators:
  - plan/spec input includes frontend, ui, react, tailwind, storybook, component
  - planned structure includes frontend/, src/components/, src/pages/, src/hooks/
  - UI state handling is in scope (loading/error/empty), accessibility, responsive design
- If uncertain whether scope is UI-related, load frontend.dev and reference design-tokens by default.
