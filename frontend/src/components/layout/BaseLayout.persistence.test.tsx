...
export const isSharedHeaderVisibleAcrossAuthenticatedPages = (): boolean => {
  ...
  return dashboardMarkup.includes("主要メニュー") && settingsMarkup.includes("主要メニュー") && dashboardMarkup.includes("忘却曲線 SSD3") && settingsMarkup.includes("忘却曲線 SSD3") && hasNoCardShellMarkup(dashboardMarkup) && hasNoCardShellMarkup(settingsMarkup);
};
